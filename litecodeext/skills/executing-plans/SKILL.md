...
**注意：** 告诉你的人类伙伴，Superpowers 在有子代理支持时效果好得多。如果在支持子代理的平台上运行（如 LiteCode 或 Codex），其工作质量会显著提高。如果子代理可用，请使用 subagent-driven-development 而非此技能。
